...
from modules.graph import find_relations, display_graph
from modules.analyse import relation_statistics
...
def main():
    ...
    relation_statistics(corealleles, relations)
    display_graph(corealleles.keys(), relations, corealleles)
