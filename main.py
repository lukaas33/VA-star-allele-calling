...
def main(text_output, image_output, selection):
    ...
    if image_output:
        ...
        for sample in selection:
            ...
            display_graph(set([n[0] for n in sample_context]) | set([n[1] for n in sample_context]), sample_context, data, functions, default_layout="dagre", relevance=variants_relevance[visualised_sample], auto_download=visualised_sample)
...
if __name__ == "__main__":
    ...
    # print(arguments)
    main(text_output=arguments.text, image_output=arguments.visual, selection=arguments.select)